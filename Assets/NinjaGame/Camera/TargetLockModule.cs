...
public class TargetLockModule : MonoBehaviour, IPlayerModule, IInputHandler
{
    ...
    void SetTarget(Transform target)
    {
        ...
        // Notify locomotion module for movement (UPDATED)
        brain.GetModule<LocomotionModule>()?.SetLockOnTarget(target);
    }
    ...
    void UnlockTarget()
    {
        ...
        // Notify locomotion module (UPDATED)
        brain.GetModule<LocomotionModule>()?.SetLockOnTarget(null);
    }
