...
public abstract class AICombatBehaviorModule : MonoBehaviour, IAICombatBehavior, IBrainModule
{
    ...
    // ⭐ IAICombatBehavior Implementation
    ...
    public virtual void ExecuteAttack()
    {
        ...
        if (debugMode)
        {
            Debug.LogWarning($"[AICombatBehaviorModule] ExecuteAttack() called but not overridden in {GetType().Name}");
        }
    }
