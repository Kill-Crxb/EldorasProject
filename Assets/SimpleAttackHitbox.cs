...
public class SimpleAttackHitbox : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (inputModule == null)
        {
            Debug.LogError("[SimpleAttackHitbox] No InputModule found!");
            enabled = false;
            return;
        }
    ...
    void Update()
    {
        ...
        if (inputModule != null && inputModule.Hotbar1Pressed && !isActive)
        {
            Attack();
        }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (damageable != null)
        {
            ...
            CombatDamagePacket packet = damageModule.CalculateDamage(attackData);
